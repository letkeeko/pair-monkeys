...
const MenuSettings: Component = () => {
  const { onChangeBackground, isDropdownOpen, setDropdownOpen } = useSettings();
  ...
  return (
    <div class="text-primary relative right-0">
      ...
      {isDropdownOpen() && (
        <div class="bg-white rounded-md font-light p-3 absolute top-[35px] sm:top-[50px] right-0 z-10 shadow-md">
          <button
